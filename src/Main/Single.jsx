  ...
  return(
    ...
    <div className="row">
        ...
        <div className="row_posters" ref={containerRef}>
            ...
            data.map((Item)=>{
                return(
                  <Image src={Item.Image} title={Item.Title} className="row_poster" onClick={()=>{navigate(`/player/${Item.Title.split(" ").join("_")}/${Item.MainCategory}/${Item.Plateform}/${Item.FileID}/1`)}} key={Item.id}/>
                )
            })
            }
